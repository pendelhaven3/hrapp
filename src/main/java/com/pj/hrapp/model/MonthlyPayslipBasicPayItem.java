...
public class MonthlyPayslipBasicPayItem extends PayslipBasicPayItem {

	private static List<Date> nonWorkingDays = new ArrayList<>();
	
	public MonthlyPayslipBasicPayItem() {
	...
	public BigDecimal getAmount() {
		return rate.multiply(getAttendancePercentage());
	}

	private BigDecimal getAttendancePercentage() {
