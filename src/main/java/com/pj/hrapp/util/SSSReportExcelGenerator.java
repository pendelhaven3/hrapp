...
public class SSSReportExcelGenerator {
    ...
    private void addNonHouseholdSubTotalRow(SSSReport report) {
        cell = row.createCell(0);
        ...
        cell = row.createCell(3);
        cell.setCellStyle(numberStyle);
        cell.setCellValue(report.getTotalNonHouseholdEmployeeContribution().doubleValue());
        
        cell = row.createCell(4);
        cell.setCellStyle(numberStyle);
        cell.setCellValue(report.getTotalNonHouseholdEmployerContribution().doubleValue());
        
        cell = row.createCell(5);
        cell.setCellStyle(numberStyle);
        cell.setCellValue(report.getTotalNonHouseholdContribution().doubleValue());
    ...
    private void addHouseholdSubTotalRow(SSSReport report) {
        ...
        cell = row.createCell(3);
        cell.setCellStyle(numberStyle);
        cell.setCellValue(report.getTotalHouseholdEmployeeContribution().doubleValue());
        
        cell = row.createCell(4);
        cell.setCellStyle(numberStyle);
        cell.setCellValue(report.getTotalHouseholdEmployerContribution().doubleValue());
        
        cell = row.createCell(5);
        cell.setCellStyle(numberStyle);
        cell.setCellValue(report.getTotalHouseholdContribution().doubleValue());
